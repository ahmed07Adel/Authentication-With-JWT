...
namespace APIJWT.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<AppUser> usermanager, RoleManager<IdentityRole> _roleManager, IConfiguration configuration, IEmailService emailService, AppDbContext context)
        {
        ...
        public async Task<object> GetGenderDropDownList()
        {
            var res = _context.Genders.ToList();
            return res;
        }
    }
} 
